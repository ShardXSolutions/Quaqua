 ...
 */
public class ListView extends ke.co.shardx.zuhura.lion.filechooser.ListView {
    ...
    protected class MyTableColumnModel extends ke.co.shardx.zuhura.lion.filechooser.ListView.MyTableColumnModel {
        @Override
    ...
    protected class MyHeaderRenderer extends ke.co.shardx.zuhura.lion.filechooser.ListView.MyHeaderRenderer {
